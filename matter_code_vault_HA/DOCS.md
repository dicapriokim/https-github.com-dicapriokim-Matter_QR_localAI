# Matter Code Vault AI v5.1.7 사용 가이드
...
- **🔑 Local AI (Ollama/LocalAI) 안내**: AI 기능을 사용하려면 로컬 AI 서버 IP가 필요합니다.
    - 입력 위치: Home Assistant 애드온 설정 페이지 > **[구성(Configuration)]** 탭 (`ollama_ip` 필드)
