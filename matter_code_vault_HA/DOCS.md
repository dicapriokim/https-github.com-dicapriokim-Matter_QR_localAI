# Matter Code Vault v3.1.0 사용 가이드

## 1. 시작하기 (Setup)
Matter Code Vault를 처음 사용할 때 가장 먼저 해야 할 일은 '분류 체계'를 잡는 것입니다.
...
- **🔑 AI Service (Google Gemini) API Key 안내**: AI 기능을 사용하려면 Google Gemini API 키가 필요합니다.
    ...
    - *무료 발급: [Google AI Studio](https://aistudio.google.com/app/apikey)에서 무료 키를 발급받을 수 있습니다.*
